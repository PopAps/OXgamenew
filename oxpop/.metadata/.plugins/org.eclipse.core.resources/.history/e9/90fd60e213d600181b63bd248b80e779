	...
	private void initialize() {
		...
		loginUsername.setColumns(10);
				...
				button_Login.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
                              FunctionLogin login = new FunctionLogin(loginUsername.getText(),new String(loginPassword.getPassword()));
						...
						lblNewLabel_2.addMouseListener(new MouseAdapter() {
							...
							public void mouseClicked(MouseEvent e) {
								...
								login.add(loginPassword);
										...
										lblNewLabel_2.setIcon(new ImageIcon(OX.class.getResource("/photo/home.png")));
										...
										login.add(lblNewLabel_2);
												...
												login.add(lblPassword_1);
														...
														login_background.setIcon(new ImageIcon(OX.class.getResource("/photo/backHome.png")));
		...
		SelectPhoto.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				registerPhoto.setIcon(new ImageIcon(OX.class.getResource(register_idPic)));
			}
		});
		...
		registerPhoto.setIcon(new ImageIcon(OX.class.getResource("/photo/profile.png")));
		...
		Button_register.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				FunctionRegister register = new FunctionRegister(registerNickname.getText(),
						                                         registerUsername.getText(),
						                                         registerPassword.getText(),
						                                         registerRepassword.getText(),
						                                         pathPhoto);
		...
		register_Background.setIcon(new ImageIcon(OX.class.getResource("/photo/backRegister.png")));
		...
		lblNewLabel_4.setIcon(new ImageIcon(OX.class.getResource("/photo/lobby.png")));
		lblNewLabel_4.setBounds(12, 13, 56, 58);
		rank.add(lblNewLabel_4);

		JLabel rank_background = new JLabel("");
		rank_background.setIcon(new ImageIcon(OX.class.getResource("/photo/backRank.png")));
		...
		homr_background.setIcon(new ImageIcon(OX.class.getResource("/photo/backHome.png")));
		...
		lblNewLabel_5.setIcon(new ImageIcon(OX.class.getResource("/photo/wait.gif")));
		...
		lblNewLabel_7
				.setIcon(new ImageIcon(OX.class.getResource("/photo/ChubbyInfiniteFlyingfox-size_restricted.gif")));
		...
		lblNewLabel_9.setIcon(new ImageIcon(OX.class.getResource("/photo/correct.png")));
		lblNewLabel_9.setBounds(570, 280, 79, 70);
		invite.add(lblNewLabel_9);

		JLabel label_9 = new JLabel("");
		label_9.setIcon(new ImageIcon(OX.class.getResource("/photo/incorect.png")));
		label_9.setBounds(661, 280, 79, 70);
		invite.add(label_9);

		JLabel lblNewLabel_6 = new JLabel("");
		lblNewLabel_6.setBackground(Color.WHITE);
		lblNewLabel_6.setIcon(new ImageIcon(OX.class.getResource("/photo/backInvite.png")));
